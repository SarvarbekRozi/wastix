<template>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                            <div class="feature-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    ...
                                    <h3><a href="/">Waste Collection</a></h3>
                                    <p>Lorem ipsum dolor sit amet consectetur elit.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                            <div class="feature-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    ...
                                    <h3><a href="/">Pickup Schedule</a></h3>
                                    <p>Lorem ipsum dolor sit amet consectetur elit.</p>
                                </div>
                            </div>
                        </div>
        ...
        <!-- service-section -->
        <section class="service-section sec-pad centred bg-color-1" id="service">
                ...
                <div class="row clearfix">
                        ...
                        <div class="service-block-one mb_35 wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    ...
                                    <h3><a href="/service-details">Garbage Pickup</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                        <div class="service-block-one mb_35 wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><a href="/service-details-2"><img src="/assets/images/service/service-2.jpg" alt=""></a></figure>
                                <div class="lower-content">
                                    <div class="icon-box">
                                        <div class="icon-bg" style="background-image: url(/assets/images/icons/icon-bg-1.png);"></div>
                                        <div class="icon"><i class="icon-13"></i></div>
                                    </div>
                                    <h3><a href="/service-details-2">Dumpster Rental</a></h3>
                                    <p>Lorem ipsum dolor sit amet consectur Dolor nunc tincidun tempor dignisime faucibus molestie.</p>
                                    <div class="link">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                        <div class="service-block-one mb_35 wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><a href="/service-details-3"><img src="/assets/images/service/service-3.jpg" alt=""></a></figure>
                                <div class="lower-content">
                                    <div class="icon-box">
                                        <div class="icon-bg" style="background-image: url(/assets/images/icons/icon-bg-1.png);"></div>
                                        <div class="icon"><i class="icon-14"></i></div>
                                    </div>
                                    <h3><a href="/service-details-3">Waste Collection</a></h3>
                                    <p>Lorem ipsum dolor sit amet consectur Dolor nunc tincidun tempor dignisime faucibus molestie.</p>
                                    <div class="link">
        ...
        <section class="cta-section centred p_relative">
            ...
            <div class="auto-container">
                <div class="inner-box">
                    ...
                    <div class="btn-box">
                        <a href="/contact" class="theme-btn btn-one"><span>Contact Us</span></a>
                        <a href="/" class="theme-btn btn-two"><span>Get a Quotes</span></a>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="project-block-one">
                        <div class="inner-box">
                            ...
                            <div class="content-box">
                                ...
                                <div class="text-box">
                                    <p>Waste Pickup</p>
                                    <h3><a href="/project-details">Garbage pickup</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="project-block-one">
                        <div class="inner-box">
                            ...
                            <div class="content-box">
                                ...
                                <div class="text-box">
                                    <p>Waste Pickup</p>
                                    <h3><a href="/project-details">Grocery waste removal</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="project-block-one">
                        <div class="inner-box">
                            ...
                            <div class="content-box">
                                ...
                                <div class="text-box">
                                    <p>Waste Pickup</p>
                                    <h3><a href="/project-details">Waste collection</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <ul class="post-info mb_6 clearfix">
                                        <li><i class="icon-24"></i><a href="/blog-details">Admin</a></li>
                                        <li><i class="icon-25"></i>0 Comnt</li>
                                    </ul>
                                    <h3><a href="/blog-details">Largest solid waste management company</a></h3>
                                    <p>Lorem ipsum dolor sit amet consectetur. Aliquet amet elementum.</p>
                                    <div class="link"><a href="/blog-details"><i class="icon-26"></i></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
