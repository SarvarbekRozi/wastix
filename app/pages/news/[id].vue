            ...
            <div class="news-block-one">
              <div class="inner-box">
                <div class="news-gallery" :class="{ 'has-thumbs': images.length > 1 }">
                  <div class="image-box">
                    <figure class="image">
                      <a :href="activeImage" class="lightbox-image" data-fancybox="news-gallery"
...
/* Views badge overlays the hero corner instead of hanging below */
...
.blog-details-content .news-block-one .inner-box .image-box .post-date h3 {
  display: inline-flex;
  align-items: center;
  gap: 8px;
  margin: 0;
