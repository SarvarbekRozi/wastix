                ...
                <div class="sortable-masonry">
                    ...
                    <div class="items-container row clearfix">
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all technology grocery hospital">
                            <div class="project-block-two">
                                <div class="inner-box">
                                    ...
                                    <div class="content-box">
                                        <div class="link-box"><a href="/project-details"><i class="icon-26"></i></a></div>
                                        <p>Waste Pickup</p>
                            ...
                            <div class="project-block-two">
                                <div class="inner-box">
                                    ...
                                    <div class="content-box">
                                        <div class="link-box"><a href="/project-details"><i class="icon-26"></i></a></div>
                                        <p>Waste Pickup</p>
                                        <h3><a href="/project-details">Dumpster rental</a></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all construction hospital">
                            <div class="project-block-two">
                                <div class="inner-box">
                                    <figure class="image-box"><img src="/assets/images/project/project-8.jpg" alt=""></figure>
                                    <div class="content-box">
                                        <div class="link-box"><a href="/project-details"><i class="icon-26"></i></a></div>
                                        <p>Waste Pickup</p>
                                        <h3><a href="/project-details">Recycling service</a></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="project-block-two">
                                <div class="inner-box">
                                    ...
                                    <div class="content-box">
                                        <div class="link-box"><a href="/project-details"><i class="icon-26"></i></a></div>
                                        <p>Waste Pickup</p>
                                        <h3><a href="/project-details">Residential service</a></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
